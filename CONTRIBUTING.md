...
Please [search for your issue before filing it: many bugs and improvements have already been reported](https://github.com/OpenHistoricalMap/iD/issues)
...
To verify a bug fix (or test a new feature), use the [test instance](http://openhistoricalmap.github.io/iD/id/).

## Contributing Documentation

Documentation is maintained as a series of [Markdown](https://guides.github.com/features/mastering-markdown/) documents in [core.yaml](/data/core.yaml). The documentation 
